...
INSERT IGNORE INTO `address` (`id_address`, `street_number`, `street_id`) VALUES
	(1, '26', 1),
	(2, '98', 2),
	(3, '32', 20),
	(4, '24', 19),
...
INSERT IGNORE INTO `bank_holiday` (`id_bank_holiday`, `date_bank_holiday`, `label_bank_holiday`, `school_year_id`) VALUES
...
-- Listage des données de la table abey_bdd.child : ~2 rows (environ)
INSERT IGNORE INTO `child` (`id_child`, `name_child`, `firstname_child`, `birthdate_child`, `child_unavaibility_id`, `user_id_1`, `user_id_2`) VALUES
...
-- Listage des données de la table abey_bdd.child_unavaibility : ~1 rows (environ)
INSERT IGNORE INTO `child_unavaibility` (`id_child_unavaibility`, `date_start_child_unaivability`, `date_end_child_unaivability`) VALUES
...
-- Listage des données de la table abey_bdd.city : ~1 rows (environ)
INSERT IGNORE INTO `city` (`id_city`, `name_city`, `zip_code`) VALUES
	(1, 'Montrouge', 92120);
...
INSERT IGNORE INTO `participation` (`id_participation`, `date_request`, `date_attribution`, `date_termination`, `user_id`, `role_id`) VALUES
...
INSERT IGNORE INTO `role` (`id_role`, `label_role`) VALUES
	(1, 'Gestionnaire'),
	(2, 'Pilote de ligne'),
	(3, 'Accompagnateur');
...
INSERT IGNORE INTO `school` (`id_school`, `name_school`, `address_id`) VALUES
	(1, 'Maurice Arnoux', 25),
	(2, 'Haut Mesnil', 26),
...
-- Listage des données de la table abey_bdd.schooling : ~2 rows (environ)
INSERT IGNORE INTO `schooling` (`id_schooling`, `school_id`, `school_year_id`, `school_level_id`, `child_id`) VALUES
	(1, 1, 1, 1, 1),
	(2, 1, 1, 2, 2),
	(3, 4, 3, 7, 3);
...
INSERT IGNORE INTO `school_holidays` (`id_school_holidays`, `date_start_school_holidays`, `date_end_school_holidays`, `label_school_holidays`, `school_year_id`) VALUES
...
INSERT IGNORE INTO `school_level` (`id_school_level`, `label_school_level`) VALUES
	(1, 'Petite Section'),
	(2, 'Moyenne Section'),
	(3, 'Grande Section'),
	(4, 'CP'),
...
-- Listage des données de la table abey_bdd.school_year : ~2 rows (environ)
INSERT IGNORE INTO `school_year` (`id_school_year`, `date_start_school_year`, `date_end_school_year`) VALUES
...
INSERT IGNORE INTO `street` (`id_street`, `name_street`, `city_id`) VALUES
...
INSERT IGNORE INTO `typical_day` (`id_typical_day`, `label_typical_day`) VALUES
	(1, 'Lundi'),
	(2, 'Mardi'),
	(3, 'Mercredi'),
	(4, 'Jeudi'),
...
INSERT IGNORE INTO `user` (`id_user`, `name_user`, `firstname_user`, `birthdate_user`, `phone_user`, `mail_user`, `date_creation_account`, `address_id`) VALUES
	(1, 'GARCIN', 'Brice', '1988-08-06', '0345456165', 'brice.garcin@eql.fr', '2022-07-19', 19),
